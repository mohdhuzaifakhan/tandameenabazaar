                ...
                <div key={shop.id} className="p-4 rounded-2xl border border-slate-200/80 bg-white flex flex-col gap-3 shadow-xs">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <span className={`inline-block px-2.5 py-0.5 rounded-full text-[9px] font-black uppercase flex-shrink-0 ${
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-2.5 border-t border-slate-100 mt-1">
                    <button 
                      ...
                      className={`py-2 rounded-xl border text-[11px] font-extrabold cursor-pointer transition-colors text-center whitespace-nowrap ${
                        shop.verified 
                    ...
                    <tr key={shop.id} className="hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="py-4 px-4 text-right">
                        <div className="flex gap-2 justify-end items-center">
                          <button 
                            onClick={() => handleToggleVerification(shop)}
                            className={`px-3 py-1.5 rounded-xl border text-[11px] font-extrabold cursor-pointer transition-all whitespace-nowrap ${
                              shop.verified 
                                ? 'border-rose-200 bg-rose-50 text-rose-700 hover:bg-rose-100' 
                                : 'border-emerald-200 bg-emerald-50 text-emerald-700 hover:bg-emerald-100'
                            }`}
                            title={shop.verified ? 'Unverify and hide store from public buyers' : 'Verify and publish store to public buyers'}
                          >
                            {shop.verified ? 'Unverify' : 'Verify'}
                          </button>
