    ...
    >
      <div>
        ...
        <div className="mt-3.5 flex flex-col">
          ...
          {/* Merchant Shop Tag */}
          <div className="flex items-center gap-1 mt-2.5 text-[9px] font-bold text-emerald-600 bg-emerald-50/50 border border-emerald-100/35 px-2 py-0.75 rounded-md w-fit">
      ...
      <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between">
        <div className="flex flex-col">
          <span className="text-[8px] font-extrabold text-slate-400 uppercase tracking-wider leading-none">Price</span>
